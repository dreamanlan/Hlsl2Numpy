...
namespace Hlsl2Numpy
{
    internal partial class ProgramTransform
    {
        ...
        internal static string GetTypeRemoveSuffix(string type, out bool isTuple, out bool isStruct, out bool isVec, out IList<int> arrNums, out string typeWithoutArrTag)
        {
